...
Rachel demos how to [build maps with {ggplot2}](https://evamaerey.github.io/rstudio_education_blog/Idaho Mapping/Idaho_mapping.html){target="_blank"} looking at the political landscape in Idaho.  She works a bunch with thematic elements with the theme() function, displaying the effect of each thematic decision step-by-step. 
