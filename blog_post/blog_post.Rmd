...
```{r, eval = F, echo = F}
url <- "../an_mtcars_flipbook_embed.html"
...
create_html_use_static_and_gif("assets/an_mtcars_flipbook_embed.png", 
                               ...
                               href = "https://evamaerey.github.io/rstudio_education_blog/an_mtcars_flipbook_embed.html", width = 700) -> 
example_reveal
...
`r australia_reveal` `r magick_reveal`

`r unemployment_reveal` `r idaho_reveal`
