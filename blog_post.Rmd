...
The 'flipbook' or code-movie technique is one that you see from time to time in coding presentations.  Presenters know that showing a code pipeline as it is built helps audiences digest workflows.  So they choreograph a set of slides to show the build; if the alignment between slides is good, and we don't have disruptive slide transitions (wipes, spins, fades) we get to enjoy a little movie.
