...
# knitr::include_graphics("an_mtcars_flipbook_embed.png")
# knitr::include_graphics("an_mtcars_flipbook_embed.gif")
...
Or you can use the "A minimal flipbook" template that comes with the package.  Using R Studio, install flipbookr (and {xaringan} if you don't have it already installed) as follows: `install.packages("flipbookr")`.  Then get the template with `File -> New File -> Rmarkdown -> A Minimal Flipbook`.  The template shows you some basic examples.
