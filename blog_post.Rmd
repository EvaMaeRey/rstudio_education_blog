...
Basically {flipbookr}, using the slide show rmarkdown tool Xaringan, will do three things: 
...
Upon compiling the .Rmarkdown file, the html slide show displays these partial builds, giving us a movie-like experience ([xaringan](https://github.com/yihui/xaringan)!). 
...
- [Side-by-side display of code and output](https://www.garrickadenbuie.com/blog/decouple-code-and-output-in-xaringan-slides/) has made alignment of output better.  
